      ...
      <header className={topbarStyles}>
        <div className="flex items-center justify-between gap-3 md:items-start">
          <div className="min-w-0 space-y-1">
            ...
            <h1 className="truncate text-base font-bold text-slate-900 dark:text-slate-100 md:text-xl lg:text-2xl">{title}</h1>
            <div className={showBreadcrumbs ? undefined : 'hidden md:block'}>
              <AdminBreadcrumbs />
            </div>
          </div>
          ...
          <button
            ...
            className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full transition hover:opacity-90 md:hidden"

...
import DriveImportStepStrip from './DriveImportStepStrip';
...
export default function DriveImportWorkflow({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-6">
      ...
      <div className="mt-5">
        <DriveImportStepStrip activeStep={activeStep} />
      </div>

      <div className="mt-4 space-y-3">
        {!canUseDrive ? (
          <div className="rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-400">Connect</p>
            ...
            <p className="mt-1 text-xs font-medium text-slate-500">{connectionLabel}</p>
            <button
              type="button"
          ...
          <div className="rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
            ...
            <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex shrink-0 flex-wrap items-center gap-2 sm:gap-3 sm:pt-0.5">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <button
                type="button"
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-slate-50 dark:text-slate-900"
